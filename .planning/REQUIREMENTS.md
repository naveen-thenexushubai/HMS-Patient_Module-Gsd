...
- [ ] **SEC-01**: System completes HIPAA Security Risk Assessment documenting all PHI storage and transmission paths
...
- [ ] **SEC-05**: System implements field-level encryption for sensitive PHI (SSN, insurance data) using Spring Crypto
- [ ] **SEC-06**: System validates JWT tokens and enforces role-based access control on all API endpoints
- [ ] **SEC-07**: System implements object-level authorization checking "can this user access THIS patient" on every data access
- [ ] **SEC-08**: System stores secrets in environment variables or secrets manager (no hardcoded credentials)
